...
public interface Layering {
    boolean isLayering(Tank tank, List<BattleFieldObject> objects, int changeX, int changeY);

    void moveInViewOfLayering(List<Player> players, List<BattleFieldObject> walls, List<BattleFieldObject> indestructibleWalls, List<BattleFieldObject> lakes, List<BattleFieldObject> eagles, MoveDirections direction, int changeX, int changeY, int numberOfPlayer);
